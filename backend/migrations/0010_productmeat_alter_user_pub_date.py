...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('backend', '0009_alter_product_catergoty_alter_product_pro_id_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='pub_date',
            field=models.DateField(default=datetime.datetime(2022, 2, 14, 12, 31, 44, 532709, tzinfo=utc)),
        ),
    ]
